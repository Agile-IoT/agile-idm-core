...
Pdp.prototype.canReadEntityPolicies = function(userInfo, entityInfo) {
  return this.canRead(userInfo, entityInfo);
};
...
Pdp.prototype.canWriteToPolicy = function (userInfo, entityInfo, policyName, policy) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        console.log("checking whether user with id " + userInfo.id + " can write to policy name " + policyName + " the value " + policy + "of entity with id " + entityInfo.id + " and entity type: " + entityInfo.type);
        var ps = [that.pap.getAttributePolicy(userInfo.id, userInfo.type),
