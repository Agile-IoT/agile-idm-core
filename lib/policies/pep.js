  ...
  return new Promise(function (resolve, reject) {
    ...
    Promise.all(ps)
      .then(function (policies) {
        ...
        //since now the policy framework supports groups now this is not needed any more...
        /*if (groups)
          filteredObject.groups = groups;*/
        Object.keys(filteredObject).forEach(function (k) {
          if (filteredObject[k] === undefined) {
            delete filteredObject[k];
          }
        });
