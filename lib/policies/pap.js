...
Pap.prototype.setEntityPolicies = function (entity_id, entity_type) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    pap.set(id, that.conf.policies.create_entity_policy).then(function (result) {
      ...
      setting.push(function() { return  pap.set(id, "groups", that.conf.policies.top_level_policy) } );
      setting.push(function() { return pap.set(id, "entities", that.conf.policies.top_level_policy) });
