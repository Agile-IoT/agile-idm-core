...
Api.prototype.getEntityPolicies = function (auth_result, entity_id, entity_type) {
    ...
    return new Promise(function (resolve, reject) {
        that.pdp.canRead(auth_result, {id: entity_id, type: entity_type}).then(function() {
...
Api.prototype.setEntityPolicy = function (auth_result, entity_id, entity_type, owner, property, policy) {
    var that = this;
    console.log('api: creating promise for setting policies of entity ' + JSON.stringify(arguments));
    return new Promise(function (resolve, reject) {
      that.pdp.canUpdate(auth_result, {id: entity_id, type: entity_type, owner: owner}).then(function() { //Todo: canUpdate enough? + Setting of owner required
