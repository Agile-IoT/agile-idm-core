...
var Pep = require('../policies/pep.js');
  ...
  var p = new Promise(function (resolve, reject) {
    that.validator.validatePromise(entity_type, entity)
      .then(function () {
        ...
        console.log("api: resolving with declassified");
  ...
  return new Promise(function (resolve, reject) {
    ...
    that.storage.readEntity(entity_id, entity_type)
      .then(function (storresult) {
        ...
        delete storageresult[attribute_name];
        return that.validator.validatePromise(entity_type, storageresult);
      }).then(function () {
...
Api.prototype.getEntityPolicies = function (entity_id, entity_type) {
  //TODO who is able to read the policices?
  return this.pap.getEntityPolicies(entity_id, entity_type);
};

Api.prototype.setEntityPolicy = function (entity_id, entity_type, property, policy) {
  return this.pap.setEntityPolicy(entity_id, entity_type, property, policy);
};
